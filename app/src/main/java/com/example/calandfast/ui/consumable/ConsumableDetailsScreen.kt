...
object ConsumableDetailsDestination : NavigationDestination {
...
@Composable
fun ConsumableDetailsScreen(
    navigateToEditItem: (Int) -> Unit,
    navigateBack: () -> Unit,
    modifier: Modifier = Modifier,
    viewModel: ConsumableDetailsViewModel = viewModel(factory = AppViewModelProvider.Factory)
) {
    ...
    Scaffold(
        ...
        ItemDetailsBody(
            ...
            onDecreaseDate = { viewModel.minusDay() },
            onIncreaseDate = {viewModel.plusDay()},
            onCopyItem = {
...
fun ItemDetailsScreenPreview() {
    CalAndFastTheme {
        ...
        ), onDecreaseDate = {}, onIncreaseDate = {}, onCopyItem = {}, onDelete = {})
    }
}